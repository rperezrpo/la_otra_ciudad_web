...
const TRANSLATIONS = {
  'alto-las-flores': {
    ...
    summary:
      'A 340 m² public-space intervention in the Alto de las Flores neighborhood, built with the community. Regenerative gardens, mural art, and safe mobility in front of a school.',
    description: `After the successful experience in the San Rafael neighborhood, La Otra Ciudad was once again selected to receive financial support of $24,000,000 COP to implement two new urban intervention projects.
...
The methodology was the same: we began with surveys of the neighborhood's residents to understand their perceptions around topics such as safety, youth, recreational spaces and community work. We then ran a series of workshops in which the community could tell us about their context, the life of their neighborhood, their needs and their proposals to make it better for everyone.
...
The next step focused on mobility in the area: the street was painted in bright colors to create more visible and safer pedestrian spaces — much needed, considering the local school's exit is right there.
...
In total, more than 340 m² of public space were transformed for the use and enjoyment of the Alto de las Flores community.`,
  ...
  'aulaviva': {
    title: 'AulaViva',
    summary:
      'Participatory refurbishment of a room in a tenement building, turning it into a community library and pedagogical refuge for the children of the Estación Villa neighborhood.',
    description: `AulaViva is a community public-space project located in the Estación Villa neighborhood, La Candelaria (Medellín's comuna 10).

The starting point was a room in a tenement building (inquilinato), a type of housing that concentrates families in vulnerable conditions in the city center. With the support of Everyday Homeless and Fundación Mi Sangre, La Otra Ciudad co-designed with the neighborhood's children the transformation of that space into a community library and pedagogical refuge.

The process unfolded across four co-creation workshops in which the children were the protagonists: they defined the uses, the colors, the materials and the objects they wanted in their new space.
...
Results: 15 m² refurbished, 4 co-creation workshops held, 30 direct participants. Budget: $3,647,686 COP (own resources + Fundación Mi Sangre).`,
  ...
  'ecos-de-la-matea': {
    ...
    description: `Ecos de la Matea is an urban socio-environmental recovery project located in the La Castellana neighborhood, Laureles (Medellín's comuna 11).
...
Partners: UMI Fund, Social Change Nest. Budget: $28,399,361 COP.`,
  ...
  'llanaditas': {
    title: 'Llanaditas',
    summary:
      'How do people see, feel and inhabit their neighborhoods? What do they think of when they think about them? How can we better understand each other’s experiences? This project set out to answer these questions.',
    description: `The Llanaditas project was our corporation's first activity.

It consisted of a two-session workshop with children between 5 and 14 years old from the Llanaditas neighborhood in comuna 8 of Medellín.

With this workshop we wanted these children to recognize and take greater ownership of the territory they inhabit, building stronger and longer-lasting bonds that allow them to inhabit and transform the space according to their needs.

Drawing on shared stories, objects, memories and experiences, we asked them to draw the neighborhood as they imagined it, according to their way of seeing and living the world. We then created an illustration bringing together everything they had put on paper, and designed and printed t-shirts with the imaginaries they had shared with us.
...
The project is developed in alliance with Parque Explora, Medellín's Secretariat of Citizen Culture, the Buen Comienzo program and the organization Medellín Conversa, which contributed citizen-conversation instruments to humanize the territorial diagnosis process.`,
  ...
  'redhonda': {
    title: 'RedHonda',
    summary:
      'La Otra Ciudad’s first consultancy: co-production of a baseline on urban expansion, land cover and socio-environmental risks in the La Honda neighborhood, Manrique.',
    description: `RedHonda is La Otra Ciudad's first formal consultancy, carried out in the La Honda neighborhood, Manrique (Medellín's comuna 3).
...
The work resulted in a set of recommendations for the neighborhood's integral improvement, aimed at community, institutional and academic actors.
...
Budget: $3,000,000 COP. LOC's first experience in applied research and territorial consultancy.`,
  ...
  'san-rafael': {
    ...
    description: `A new stage began for La Otra Ciudad with a great opportunity: the Barrios Vivos program.

In 2022 La Otra Ciudad was selected as the winner of the S2Cities program and received a financial incentive of $2,850,000 COP to implement a public-space transformation project. After several analyses and fieldwork, we chose the San Rafael neighborhood in Envigado, whose characteristics posed a great challenge for making effective use of the territory.

The intervention of this space, which had been used only as a passing corridor, began with a large mural donated by a local artist, representing the spirit the neighborhood's residents dreamed of for their home: nature, birds, color and life.
...
One of the biggest problems identified in the area was the lack of play and recreation areas for local children. So we turned a concrete slab that served as an informal motorbike parking lot into a new playground where children can be physically active, develop their motor skills and even learn music without having to go far from home.
...
And so, together, young and old, we took the project from paper to reality and made this dream come true, transforming more than 150 m² of public space for the benefit of the residents of the San Rafael neighborhood.`,
  },
}
